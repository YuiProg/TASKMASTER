...
class MyTasks extends React.Component {
  ...
  getFilteredTasks = () => {
    const { myTasks, search } = this.state;
    ...
    if (filtered.length === 0) {
      return (
        <div className="tasks-grid__empty">
          <p>{search ? `No tasks matching "${search}"` : "No tasks assigned to you yet."}</p>
        </div>
      );
    }
              ...
              >
                ...
                <div className="tasks-grid__card-footer">
                  ...
                  <div className="tasks-grid__meta-group">
                    <span className="tasks-grid__meta" title="Reporter">
                      <User size={12} />
  ...
  render() {
    ...
    return (
      <PanelPage titlePage="My Tasks" subTitle="All tasks currently assigned to you.">
        <Helmet>
